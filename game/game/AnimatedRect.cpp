...
AnimatedRect::AnimatedRect(const char* map_filename, int rows, int cols, int rate, float x = 0, float y = 0, float w = 0.5, float h = 0.5) : TexRect(map_filename, x, y, w, h), complete(true), animating(false), loop(false) {
